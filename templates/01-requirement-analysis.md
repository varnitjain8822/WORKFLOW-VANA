# {{PROJECT_NAME}} - Requirement Analysis
...
This document outlines the complete requirements for {{PROJECT_NAME}}, including functional requirements, non-functional requirements, system constraints, and user expectations.
...
|--------|--------|-------------------|
| User Adoption | {{TARGET_USERS}} users in first month | Analytics tracking |
...
> **CRITICAL AI INSTRUCTION:** You must actively ask the user if there are any known security issues, strict security requirements, or vulnerabilities associated with this project. Pause and wait for the user's input regarding security concerns before finalizing the requirements document.
...
### Security Assessment Checkpoint
You must actively ask the user if there are any known security issues, strict security requirements, or vulnerabilities associated with this project. Pause and wait for the user's input regarding security concerns before finalizing the requirements document.
